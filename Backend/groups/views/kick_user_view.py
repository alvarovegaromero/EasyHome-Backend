    ...
    def post(self, request, group_id, user_id):
        try:
            ...
            if request.user != group.owner:
                return Response(
                    {'error': "Only the group owner can kick users"}, status=status.HTTP_403_FORBIDDEN)
            ...
            return Response(
                {'success': "User has been succesfully kicked from the group"}, status=status.HTTP_200_OK)
